...
#define CUSTOM_MACHINE_NAME "Ares"
...
#define DELTA
  ...
  #define DELTA_RADIUS 114.5 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 120, 120, 120, 94 }  // default steps per unit for Kossel (GT2, 20 tooth)
